...
<head>
    ...
    <title>Edit Pengalaman Pameran</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="form-container">
        <h2 class="form-title">Edit Pengalaman Pameran</h2>
        <form action="<?= base_url('pameran/update/' . $pameran['id_pameran']) ?>" method="post">
            <div class="row g-3">
                <!-- Kolom kiri -->
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="namaPameran" name="nama_pameran" 
                            value="<?= htmlspecialchars($pameran['nama_pameran'], ENT_QUOTES) ?>" 
                            placeholder="Masukkan nama pameran" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggalPameran" name="tanggal_pameran" 
                            value="<?= $pameran['tanggal_pameran'] ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="lokasiPameran" name="lokasi_pameran" 
                            value="<?= htmlspecialchars($pameran['lokasi_pameran'], ENT_QUOTES) ?>" 
                            placeholder="Masukkan lokasi pameran" required>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsiPameran" class="form-label">Deskripsi Pameran</label>
                        <textarea class="form-control" id="deskripsiPameran" name="deskripsi_pameran" rows="3"
                            placeholder="Masukkan deskripsi pengalaman pameran"><?= htmlspecialchars($pameran['deskripsi_pameran'], ENT_QUOTES) ?></textarea>
                    </div>
                </div>
            </div>
