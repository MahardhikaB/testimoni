...
<body>
    <div class="form-container">
        <h2 class="form-title">Tambah Media</h2>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="namaMedia" name="nama_media" placeholder="Masukkan Nama Media" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="tahunMedia" name="tahun_media" placeholder="Masukkan Tahun Media" required>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsiMedia" class="form-label">Deskripsi Media</label>
                        <textarea class="form-control" id="deskripsiMedia" name="deskripsi_media" rows="3" placeholder="Masukkan Deskripsi Media"></textarea>
                    </div>
                </div>
            </div>
