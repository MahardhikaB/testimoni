...
<body>
    <div class="form-container">
        ...
        <form action="<?= base_url('program/update/' . $program['id_program']) ?>" method="post">
            <div class="row g-3">
                <!-- Kolom kiri -->
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="namaProgram" name="nama_program"
                            value="<?= htmlspecialchars($program['nama_program'], ENT_QUOTES) ?>" placeholder="Masukkan Nama Program" required>
                    </div>
                    <div class="mb-3">
                        <label for="tahunProgram" class="form-label">Tahun Program</label>
                        <input type="number" class="form-control" id="tahunProgram" name="tahun_program"
                            value="<?= htmlspecialchars($program['tahun_program'], ENT_QUOTES) ?>" placeholder="Masukkan Tahun Program" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="penyelenggaraProgram" name="penyelenggara_program"
                            value="<?= htmlspecialchars($program['penyelenggara_program'], ENT_QUOTES) ?>" placeholder="Masukkan Penyelenggara Program" required>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsiProgram" class="form-label">Deskripsi Program</label>
                        <textarea class="form-control" id="deskripsiProgram" name="deskripsi_program" rows="3" placeholder="Masukkan Deskripsi Program"><?= htmlspecialchars($program['deskripsi_program'], ENT_QUOTES) ?></textarea>
                    </div>
                </div>
            </div>
